...
export default function Home() {
  ...
  return (
    <main className="flex -ml-8 flex-col items-center justify-between py-14">
      <div className="flex gap-3 -mt-10 md:mt-0">
        <div className="md:-mt-5 -mt-10">
          <Image
            src={img}
            className="w-[400px] h-[600px] hidden md:block"
            width={300}
            height={400}
          />
        </div>
        <div className="flex-1 flex items-center justify-center">
          <div className="h-screen flex flex-col items-center">
            <div className="bg-white md:border md:border-gray-300 w-80 py-8 flex items-center flex-col mb-3">
            ...
            <div className="bg-white md:border md:border-gray-300 text-center w-80 py-4">
      ...
      <div className="-mt-36 p-10 md:p-4 text-sm text-gray-600">
